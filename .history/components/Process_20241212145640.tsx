    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 mx-auto px-8">
        ...
        title="Planning & Strategy"
         ...
         description="We'll collaborate to map out your website's goals, target audience, and key functionalities. We'll discuss things like site structure, navigation, and"
         >
          <CanvasRevealEffect
            animationSpeed={5.1}
