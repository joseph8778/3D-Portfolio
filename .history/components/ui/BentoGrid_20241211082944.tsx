            ...
            <div>
                ...
                {id === 3 && (
                  <div className="flex gap-1 lg:gap-4 w-fit absolute -right-3 lg:-right-0">
                    <div className="flex flex-col gap-3 md:gap-3 lg:gap-5 lg:pt-2 ">
                      {['HTML', 'CSS/Tailwind', 'Javascript'].map((item) => (
                        <span key={item} className="py-2 lg:min-w-20 lg:py-1.5 lg:px-2 px-3 text-xs opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]">
                          {item}
                        </span>
                      ))}
                    ...
                    <div className="flex flex-col gap-3 md:gap-3 lg:gap-5">
                      ...
                      {['React', '3JS', 'GSAP'].map((item) => (
                        <span key={item} className="py-2 lg:min-w-20 lg:py-1.5 lg:px-2 px-3 lg:pt-2 text-xs opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]">
                          {item}
                        </span>
                      ))}
                    </div>
