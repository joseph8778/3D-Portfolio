                  ...
                  <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-0">
                    <div className="flex flex-col gap-3 md:gap-3 lg:gap-4 ">
                      {['HTML', 'CSS/Tailwind', 'Javascript'].map((item) => (
                        <span key={item} className="py-2 lg:py-2 lg:px-2 px-3 text-xs opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]">
                          {item}
                        </span>
                      ))}
                    ...
                    <div className="flex flex-col gap-3 md:gap-3 lg:gap-4 ">
                      ...
                      {['React', '3JS', 'GSAP'].map((item) => (
                        <span key={item} className="py-2 min-w-10 lg:py-2 lg:px-2 px-3 text-xs opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]">
                          {item}
                        </span>
                      ))}
                    </div>
