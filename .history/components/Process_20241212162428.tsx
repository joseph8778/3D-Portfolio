...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2] mmb-10  max-w-sm w-full mx-auto p-4 relative h-[30rem] rounded-3xl lg:h-[30rem]"
    >
